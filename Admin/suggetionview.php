<?php
	...
	if(isset($_REQUEST["d"]))
	{
		...
		$delete=$_REQUEST["d"];
		$qry="delete from suggetion where name='$delete'";
	...
	if($b=="Search")
	{
		$qry="select * from suggetion where name like '$a%' ";	
	}
	else 
	{
		$qry="select * from suggetion";		
	}

	$tb=mysql_query($qry,$link);
	$chk=mysql_num_rows($tb);
?>
<body background="../flasher/13.jpg">
<form method=post action="suggetionview.php">
...
<table border=1 width=810 align=center class=first bgcolor=#999999>
	<tr valign=center align=center bgcolor=#CCCCCC>
		<td colspan=3><font color=red><b>Enter User Name </b></font></td>
...
<?php
	...
	{  
		echo("<tr align=center bgcolor=#CCCCCC> 
			 <td width=50><img src='../flasher/sr.png'></td>
			 <td width=100><img src='../flasher/userlist.png'></td>
			 <td width=60><font color=green size=3>MobileNo.</td>
			 <td width=140><font color=green size=3>Email Id</td>
			 <td width=110><font color=green size=3>Subject</td>
			 <td width=110><img src='../flasher/email.png'>Suggetion</td>
		...
		{	
			...
			echo ("<td align=center><a href='suggetionview.php?d=$row[1]'>Delete</a></td>");
		echo("</tr>");
		}	
		echo("</table>");
	}
